export const MatchDisplay = {
  displayCard(match, clone, onEdit, onDelete, userRole) {
    try {
      ...
      if (cityEl) cityEl.innerHTML = `<img src="/src/assets/location.png" alt="Localización" style="width: 24px; height: 24px; vertical-align: middle;"> ${match.city || ''}`;
      ...
      if (weatherText.includes('lluvia')) {
        ...
        weatherIcon = `<img src="/src/assets/cloudy.png" alt="Nuboso" class="weather-icons">`;
      } else if (weatherText.includes('cielo')) {
        weatherIcon = `<img src="/src/assets/sun.png" alt="Soleado" class="weather-icons">`;
      } else if (weatherText.includes('nubes')) {
        weatherIcon = `<img src="/src/assets/clouds.png" alt="Nubes" class="weather-icons">`;
      } else if (weatherText.includes('tormenta')) {
        weatherIcon = `<img src="/src/assets/storm.png" alt="Tormenta" class="weather-icons">`;
      } else if (weatherText.includes('nieve')) {
        weatherIcon = `<img src="/src/assets/snow.png" alt="Nieve" class="weather-icons">`;
      } else {
        weatherIcon = `<img src="/src/assets/standardweather.png" alt="Clima" class="weather-icons">`;
      }
